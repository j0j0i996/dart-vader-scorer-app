    ...
    return (
        <BottomTab.Navigator>
            <BottomTab.Screen 
                ...
                options={{
                tabBarIcon: () => <Icon name='play-circle-outline' type='materialicons' color={colors.lightgray} size={28} />,
                }}
            />
            <BottomTab.Screen 
                name="Calibration"
                ...
                options={{
                tabBarIcon: () => <Icon name='tune' type='materialicons' color={colors.lightgray} size={28} />,
            }}/>
      </BottomTab.Navigator>
    );
  }
